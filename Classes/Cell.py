...
class Cell:
    def __init__(self,  win:Window, left_wall = True, right_wall = True, top_wall = True, bottom_wall = True) -> None:
        ...
        self._y1 = None
        self._y2 = None
    def draw(self, x1, y1, x2, y2, fill_color):
        #set Cell variables
        self._x1 = x1
        self._x2 = x2
        self._y1 = y1
        self._y2 = y2
        #generate points for cell corners
